/***************************************************************************************
*    Title: GodotSharp/GodotSharp/Core/Vector2I.cs
*    Author: GodotEngine
*    Date: 04/08/2025
*    Code version: 4.4.1
*    Availability: https://github.com/raulsntos/godot/blob/master/modules/mono/glue/GodotSharp/GodotSharp/Core/Vector2I.cs
***************************************************************************************/
...
namespace Repl.Server.Core.MathUtils;
    ...
    public struct Vector2I : IEquatable<Vector2I>
    {
        ...
        public readonly ReplGameProtocol.Vector2I ToProto()
        {
            return new ReplGameProtocol.Vector2I()
            {
                X = X,
                Y = Y
            };
